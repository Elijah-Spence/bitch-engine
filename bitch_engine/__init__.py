...
SUBSTRATE_CHAIN = [
    ...
    {"name": "javascript",  "ext": ".js",  "cmd": ["node"],              "timeout": 10},
    {"name": "typescript",  "ext": ".ts",  "cmd": ["npx", "ts-node"],    "timeout": 10},
    {"name": "shell",       "ext": ".sh",  "cmd": ["bash"],              "timeout": 10},
    {"name": "perl",        "ext": ".pl",  "cmd": ["perl"],              "timeout": 10},
    {"name": "ruby",        "ext": ".rb",  "cmd": ["ruby"],              "timeout": 10},
    {"name": "lua",         "ext": ".lua", "cmd": ["lua"],               "timeout": 10},
    {"name": "php",         "ext": ".php", "cmd": ["php"],               "timeout": 10},
    ...
    {"name": "java",        "ext": ".java","cmd": ["javac"],             "compile": True, "run": ["java", "-cp", "_dir", "Main"]},
    {"name": "rust",        "ext": ".rs",  "cmd": ["rustc", "-o", "_out", "_file.rs"], "compile": True, "run": ["./_out"]},
    {"name": "haskell",     "ext": ".hs",  "cmd": ["runghc"],            "timeout": 10},
    {"name": "kotlin",      "ext": ".kt",  "cmd": ["kotlinc", "-script"], "timeout": 10},
    {"name": "scala",       "ext": ".scala","cmd": ["scala"],            "timeout": 10},
    {"name": "dart",        "ext": ".dart","cmd": ["dart", "run"],       "timeout": 10},
    {"name": "swift",       "ext": ".swift","cmd": ["swiftc", "-o", "_out", "_file.swift"], "compile": True, "run": ["./_out"]},
    {"name": "go",          "ext": ".go",  "cmd": ["go", "run"],         "timeout": 10},
    {"name": "clojure",     "ext": ".clj", "cmd": ["clojure"],           "timeout": 10},
    {"name": "erlang",      "ext": ".erl", "cmd": ["escript"],           "timeout": 10},
    {"name": "scheme",      "ext": ".scm", "cmd": ["guile"],             "timeout": 10},
    {"name": "r",           "ext": ".r",   "cmd": ["Rscript"],           "timeout": 10},
    {"name": "julia",       "ext": ".jl",  "cmd": ["julia"],             "timeout": 10},
    {"name": "elixir",      "ext": ".exs", "cmd": ["elixir"],            "timeout": 10},
    ...
    {"name": "nim",         "ext": ".nim", "cmd": ["nim", "c", "-r"],    "timeout": 15},
    {"name": "v",           "ext": ".v",   "cmd": ["v", "run"],          "timeout": 10},
    {"name": "odin",        "ext": ".odin","cmd": ["odin", "run"],        "timeout": 10},
    {"name": "zig",         "ext": ".zig", "cmd": ["zig", "build-exe"],  "timeout": 10},
    {"name": "assembly",    "ext": ".asm", "cmd": ["nasm", "-f", "elf64", "_file.asm", "-o", "_out.o"], "compile": True, "run": ["ld", "_out.o", "-o", "_out", "-lc"]},
    {"name": "powershell",  "ext": ".ps1", "cmd": ["pwsh", "-File"],     "timeout": 10},
    {"name": "fsharp",      "ext": ".fs",  "cmd": ["dotnet", "fsi"],     "timeout": 10},
    {"name": "ocaml",       "ext": ".ml",  "cmd": ["ocaml"],             "timeout": 10},
    {"name": "lisp",        "ext": ".lisp","cmd": ["sbcl", "--script"],   "timeout": 10},
    {"name": "racket",      "ext": ".rkt", "cmd": ["racket"],            "timeout": 10},
    {"name": "tcl",         "ext": ".tcl", "cmd": ["tclsh"],             "timeout": 10},
    {"name": "groovy",      "ext": ".groovy","cmd": ["groovy"],          "timeout": 10},
    {"name": "prolog",      "ext": ".pro","cmd": ["swipl", "-g", "halt", "-l"], "timeout": 10},
    {"name": "ada",         "ext": ".adb", "cmd": ["gnatmake"],          "timeout": 10},
    {"name": "cobol",       "ext": ".cob", "cmd": ["cobc", "-x", "-o", "_out", "_file.cob"], "compile": True, "run": ["./_out"]},
    {"name": "forth",       "ext": ".fth", "cmd": ["gforth"],            "timeout": 10},
    {"name": "brainfuck",   "ext": ".bf",  "cmd": ["bf"],                "timeout": 10},
    {"name": "awk",         "ext": ".awk", "cmd": ["awk", "-f"],         "timeout": 10},
    {"name": "sed",         "ext": ".sed", "cmd": ["sed", "-n", "-f"],   "timeout": 10},
    {"name": "makefile",    "ext": ".mk",  "cmd": ["make", "-f"],        "timeout": 10},
    {"name": "cmake",       "ext": ".cmake","cmd": ["cmake", "-P"],      "timeout": 10},
]
